...
SECRET_KEY = 'django-insecure-tc=@afu*s$s9xwxq%#c$@if1@1%073*3ap89w1)ij66c10+zbm'
...
STATIC_URL = '/static/'
# Ensure this is present if you're working with a 'static' folder in your project directory.
STATICFILES_DIRS = [
    BASE_DIR / "static",  
]
